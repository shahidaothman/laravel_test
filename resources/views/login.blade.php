...
<head>
  ...
  <meta charset="utf-8" />
  <title>Horizontal | Morvin - Admin & Dashboard Template</title>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button">
                  <i class="dripicons-archive me-2"></i> Loan <div class="arrow-down"></div>
                </a>
                <div class="dropdown-menu" aria-labelledby="topnav-apps">

                  <a href="calendar.html" class="dropdown-item">Personal</a>

                  <a href="chat.html" class="dropdown-item">Business</a>
                  <a href="chat.html" class="dropdown-item">Home</a>
              
                  <a href="chat.html" class="dropdown-item">Car</a>
                  <a href="chat.html" class="dropdown-item">Educational Plan</a>
                  <a href="chat.html" class="dropdown-item">Other</a>
                </div>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                <a href="chat.html" class="dropdown-item">Download</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button">
                  <i class="dripicons-archive me-2"></i> Branch <div class="arrow-down"></div>
                </a>
                <div class="dropdown-menu" aria-labelledby="topnav-apps">

                  <a href="calendar.html" class="dropdown-item">Location</a>

                  <a href="chat.html" class="dropdown-item">Appointment Branch</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button">
                  <i class="dripicons-archive me-2"></i> Career <div class="arrow-down"></div>
                </a>
                <div class="dropdown-menu" aria-labelledby="topnav-apps">

                  <a href="calendar.html" class="dropdown-item">Job Opening</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button">
                  <i class="dripicons-archive me-2"></i> Contact Us 
                </a>
